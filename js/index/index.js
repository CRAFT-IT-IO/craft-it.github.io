...
$(function () {
    ...
    setTimeout(function () {
        ...
        //setTimeout(function () {
        initContentMenu(['I.T. Lab FOR BESKOPEN SOLUTION IN RISK MANAGEMENT'], { delay: 40, withAnimation: true, contentDirection: 'bottom' },
            function () {
            ...
            //        if (animationIndex > animationCount)
            //            animationCount = animationIndex;
            //        else if (animationIndex == animationCount) {
